      ...
      <div className={styles.left}>
        ...
        <div>
          <div style={{ textAlign: "justify",marginTop:"2rem" }}>
            <h3>Trip OverView</h3>
            <p style={{color:"gray"}}>{data?.hiking?.overview}</p>
          </div>
          ...
          <div style={{ textAlign: "justify",marginTop:"2rem" }}>
            ...
            <p style={{color:"gray"}}>{data?.hiking?.comprehensiveGuide}</p>
          </div>
        ...
        <div>
          ...
          <div style={{ width: "100%", height: "400px", overflow: "scroll" }}>
            <img src={data?.hiking?.map} width={"100%"} alt="map" />
          </div>
        </div>
        <div>
          <Table striped bordered hover>
          ...
          {data?.hiking?.usefulInfo?.map((item) => {
            return (
              <div key={item.usefulInfoTitle}>
                ...
                <p style={{colo:"gray"}}>{item.usefulInfoDescription}</p>
              </div>
            );
          })}
        </div>
        ...
        <div style={{marginTop:"2rem"}}>
          ...
          <p style={{colo:"gray"}}>{data?.hiking?.experienceRequired}</p>
        </div><div style={{marginTop:"2rem"}}>
          <h5>Best Time To Travel</h5>
          <p style={{colo:"gray"}}>{data?.hiking?.bestTimeToTravel}</p>
        </div>
        <div style={{marginTop:"2rem"}}>
          <h5>Visa And Entry Procedures</h5>
          <p style={{colo:"gray"}}>{data?.hiking?.visaAndEntryProcedure}</p>
        </div>
        <div style={{marginTop:"2rem"}}>

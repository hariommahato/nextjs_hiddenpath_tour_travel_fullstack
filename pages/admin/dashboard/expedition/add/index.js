...
const Expedition = () => {
  ...
  const [createExpeditionData, { isSuccess, isError }] =
  ...
  async function handleTourImageAdd() {
    ...
    toast.success("Tour Image Added");
    return;
  }
  async function handleMapAdd() {
    ...
    toast.setUsefulInfo("TourMap Added");
    return;
  }
  ...
  return (
    ...
    <Toaster/>
      ...
      <Row style={{ marginTop: "2rem" }}>
        ...
        <Col xs={12} sm={12} md={12} lg={12}>
          ...
          <div style={{ display: "flex", gap: "10px" }}>
            <Button onClick={handleUpload} style={{ marginTop: "0.6rem" }}>
              Add More
            </Button>
            <Button
              variant="danger"
      ...
      <Row>
        ...
        <div style={{ marginTop: "0.4rem", width: "10rem" }}>
      ...
      <Row>
        ...
        {priceExcluded.map((item) => {
          return <p key={item.priceExcludedItem}>{item.priceExcludedItem}</p>;
        })}
        <div style={{ marginTop: ".5rem", display: "flex", gap: "10px" }}>

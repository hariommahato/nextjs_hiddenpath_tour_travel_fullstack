...
const Hiking = () => {
  ...
  const [createHiking, { isSuccess, isError }] = useCreateHikingMutation();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      router.push("/admin/dashboard/hiking");
    }
    if (isError) {
      toast.error(isError);
    }
  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <div style={{ marginTop: "0.3rem",width:"10rem" }}>

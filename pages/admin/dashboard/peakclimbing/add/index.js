...
const PeakClimbing = () => {
  ...
  const [createPeakClimbingData, { isSuccess, isError }] =
  ...
  async function handleMapAdd() {
    ...
    toast.success("TourMap   Uploaded");
    return;
  }
  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <div style={{ marginTop: ".3rem", display: "flex", gap: "10px",marginTop:"1rem"}}>
      ...
      <Row>
        ...
        {priceExcluded.map((item) => {
          return <p key={priceExcludedItem}>{item.priceExcludedItem}</p>;
        })}
        <div style={{ marginTop: ".5rem", display: "flex", gap: "10px" }}>

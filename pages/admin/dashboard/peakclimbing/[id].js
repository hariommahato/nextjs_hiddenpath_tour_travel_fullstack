...
export default function PeakClimbing() {
  ...
  const [updatePeakClimbingData, { isSuccess, isError }] =
    useUpdatePeakClimbingDataMutation();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      router.push("/admin/dashboard/peakclimbing");
    }
    if (isError) {
      toast.error(isError);
    }
  ...
  async function handleHomeImageCarousel() {
    ...
    toast.success("CarouselImageAdded");
    return;
  }
  async function handleTourImage() {
    ...
    toast.success("TourImages Added");
    return;
  }
  return (
    <>
      ...
      <Container>
        ...
        <Row>
          <Col xs={12} sm={12} md={6} lg={6}>
            ...
            <Button onClick={handleHomeImageCarousel} style={{marginTop:"0.5rem"}}>Add Carousel Image</Button>
          </Col>
        </Row>
        <Button
        ...
        <Row>
          <Col xs={12} sm={12} md={6} lg={6}>
            ...
            <div style={{marginTop:"0.5rem"}}>
              <Button onClick={handleTourImage}>Add Tour Images</Button>
            </div>
            <div>
              <Button
                style={{ marginTop: "1rem" }}
...
PeakClimbing.getLayout = function PageLayout(page) {
  return (
    <>
      <Providers>
        <DashboardNavbar />
